...
public class ProfileServices {
    ...
    private ProfileEntity toEntity(ProfileDTO profileDTO) {
        ProfileEntity profileEntity = ProfileEntity.builder()
                ...
                .ProflieImageUrl(profileDTO.getProflieImageUrl())
    ...
    public ProfileDTO toDTO(ProfileEntity profileEntity) {
        ProfileDTO profileDTO = ProfileDTO.builder()
                ...
                .ProflieImageUrl(profileEntity.getProflieImageUrl())
    ...
    public ProfileDTO getPublicProfile(String email){
        ...
        .ProflieImageUrl(currentUser.getProflieImageUrl())
    ...
    public  Map<String,Object> authenticateAndGenerateToken(AuthDTO authDTO) {
        try {
           ...
           // final UserDetails userDetails = appUserDetailServices.loadUserByUsername(authDTO.getEmail());
